...
dx, dy, ds = sc.support_system.get_total_offset(element_index)
roll, pitch, yaw = at_angles_from_rotation(sc.support_system.get_total_rotation(element_index))
print(
    f"Before endpoint move: offset [dx, dy, ds] = {np.array([dx, dy, ds])}, "
...
roll, pitch, yaw = at_angles_from_rotation(sc.support_system.get_total_rotation(element_index))
print(
    f"After endpoint move: offset [dx, dy, ds] = {np.array([dx, dy, ds])}, "
    f"angles [roll, pitch, yaw] = {np.array([roll, pitch, yaw])}"
)
